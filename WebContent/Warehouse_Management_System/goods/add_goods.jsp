...
<body>
	...
	<h2>增加货物类型</h2>
	<form action="add_goods_check.jsp" method="post" onsubmit="return check()">	
		请输入货号：<input type="text" name="newid" id="newid"/><br/>
		请输入货箱长度：<input type="text" name="length" id="length"><br/>
		请确认货箱宽度：<input type="text" name="width" id="width"><br/>
		请确认货箱高度：<input type="text" name="heigth" id="heigth"><br/>
