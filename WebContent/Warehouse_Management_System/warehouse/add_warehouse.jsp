...
<body>
	...
	<h2>增加仓库</h2>
	<form action="add_warehouse_check.jsp" method="post" onsubmit="return check()">	
		请输入仓库号：<input type="text" name="newid" id="newid"/><br/>
		请输入仓库长度：<input type="text" name="length" id="length"><br/>
		请确认仓库宽度：<input type="text" name="width" id="width"><br/>
		请确认仓库高度：<input type="text" name="heigth" id="heigth"><br/>
